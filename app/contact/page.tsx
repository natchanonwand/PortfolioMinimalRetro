  ...
  return (
    <section className='flex h-[640px]'>
      <div className='container py-12 '>
        ...
        <h2 className="w-72 text-8xl font-bauhaus text-center text-transparent" style={{ WebkitTextStroke: '2px black' }}>
          <span style={{ WebkitTextStroke: '2px #FFAD00' , color:'#FFAD00' }}>C</span>onta<span style={{ WebkitTextStroke: '2px #FFAD00', color:'#FFAD00' }}>c</span>t
        </h2>
        ...
        <div className='flex flex-col gap-4'>
          <motion.div
            ...
            style={{ width: '360px' }}
            className='flex-1 p-6 rounded-3xl shadow-lowneumorphism hover:shadow-lg hover:rounded-3xl transition-shadow duration-300 hover:shadow-neumorphism'>
      ...
      <div className='hidden md:block overflow-hidden border-l-4 border-black' style={{ width: "680px", position: 'relative' }}>
        <video 
          src="Contact.mp4" 
          muted 
          autoPlay 
